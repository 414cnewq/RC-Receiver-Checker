...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("4a0256ab-d526-4c0a-be68-66595f015922/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=1667, TCPrescaler=6, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Analog_Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Analog_Timer, CY_INSTANCE_SHORT_NAME=Analog_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Analog_Timer, )
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_1011 or Net_1010 or Net_1009 or Net_1008 or Net_997 or Net_996 or Net_995 or Net_994 or Net_297)
        begin
            case (Net_297[2:0])
                3'b000 :  tmp__mux_1_reg = Net_1011;
                3'b001 :  tmp__mux_1_reg = Net_1010;
                3'b010 :  tmp__mux_1_reg = Net_1009;
                3'b011 :  tmp__mux_1_reg = Net_1008;
                3'b100 :  tmp__mux_1_reg = Net_997;
                3'b101 :  tmp__mux_1_reg = Net_996;
                3'b110 :  tmp__mux_1_reg = Net_995;
                3'b111 :  tmp__mux_1_reg = Net_994;
            endcase
        end
        assign Net_1469 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("251c89ac-21d7-4baf-b447-d3a6a5560853"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e04a3ec4-a8bf-419d-a80b-2f8ed55e67f4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4c8a124c-bc77-4525-959e-9d8f722da7ab"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("df51e2fc-fdd5-4731-9a8b-c2ac81c392a6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("681c8db6-7f56-482d-a1fc-4523d758744f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PWM_6_net;
	wire [0:0] tmpIO_0__PWM_6_net;
	wire [0:0] tmpINTERRUPT_0__PWM_6_net;
	electrical [0:0] tmpSIOVREF__PWM_6_net;

	cy_psoc3_pins_v1_10
		#(.id("91932060-c50a-4f6d-bddd-0ed0ed6a47a9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWM_6
		 (.oe(tmpOE__PWM_6_net),
		  .y({1'b0}),
		  .fb({Net_996}),
		  .io({tmpIO_0__PWM_6_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_6_net),
		  .interrupt({tmpINTERRUPT_0__PWM_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_5_net;
	wire [0:0] tmpIO_0__PWM_5_net;
	wire [0:0] tmpINTERRUPT_0__PWM_5_net;
	electrical [0:0] tmpSIOVREF__PWM_5_net;

	cy_psoc3_pins_v1_10
		#(.id("7b50c6d1-3f14-48ed-b473-e065da198d1e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWM_5
		 (.oe(tmpOE__PWM_5_net),
		  .y({1'b0}),
		  .fb({Net_997}),
		  .io({tmpIO_0__PWM_5_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_5_net),
		  .interrupt({tmpINTERRUPT_0__PWM_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_1451),
    ...
    TCPWM_P4_v2_10_1 PWM_Timer_Pulse (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("5c6a7a0e-b4c2-45cb-a3f1-4e46587acf8a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
    ...
    CyControlReg_v1_80 PinSelect (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_297[2:0]));
    defparam PinSelect.Bit0Mode = 0;
    defparam PinSelect.Bit1Mode = 0;
    defparam PinSelect.Bit2Mode = 0;
    defparam PinSelect.Bit3Mode = 0;
    defparam PinSelect.Bit4Mode = 0;
    defparam PinSelect.Bit5Mode = 0;
    defparam PinSelect.Bit6Mode = 0;
    defparam PinSelect.Bit7Mode = 0;
    defparam PinSelect.BitValue = 0;
    defparam PinSelect.BusDisplay = 1;
    defparam PinSelect.ExtrReset = 0;
    defparam PinSelect.NumOutputs = 3;
	...
	cy_psoc3_pins_v1_10
		#(.id("543066c7-e2d4-4ac2-bc3c-d46f258b5c38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PWM_7_net;
	wire [0:0] tmpIO_0__PWM_7_net;
	wire [0:0] tmpINTERRUPT_0__PWM_7_net;
	electrical [0:0] tmpSIOVREF__PWM_7_net;

	cy_psoc3_pins_v1_10
		#(.id("a11200e2-1ed5-4f3c-bdd3-504206f4aeb6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWM_7
		 (.oe(tmpOE__PWM_7_net),
		  .y({1'b0}),
		  .fb({Net_995}),
		  .io({tmpIO_0__PWM_7_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_7_net),
		  .interrupt({tmpINTERRUPT_0__PWM_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_8_net;
	wire [0:0] tmpIO_0__PWM_8_net;
	wire [0:0] tmpINTERRUPT_0__PWM_8_net;
	electrical [0:0] tmpSIOVREF__PWM_8_net;

	cy_psoc3_pins_v1_10
		#(.id("e9840b30-857b-4959-80d9-7cd0fcf82596"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWM_8
		 (.oe(tmpOE__PWM_8_net),
		  .y({1'b0}),
		  .fb({Net_994}),
		  .io({tmpIO_0__PWM_8_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_8_net),
		  .interrupt({tmpINTERRUPT_0__PWM_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
